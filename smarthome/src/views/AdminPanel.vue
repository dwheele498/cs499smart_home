  ...
  <v-main>
    <v-container fluid>
      <v-row class="justify-center">
        <v-banner><v-icon class="material-icons">house</v-icon>Rooms</v-banner>
      ...
      <v-row>
        <v-banner
          ><v-icon class="material-icons">sensor_door</v-icon>Doors</v-banner
        >
      ...
      <v-row>
        <v-banner
          ><v-icon class="material-icons">water_damage</v-icon>Water</v-banner
        >
